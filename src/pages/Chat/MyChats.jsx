    ...
    return (
        <div className={`md:w-[30%] w-full p-2 h-full bg-white my-chats rounded ${selectedChat ? "hidden" : "block"} md:block`}>
            <div className="title flex gap-2 justify-between my-3">
                <p className='text-xl mx-3 '>My Chats</p>
                <div className="add-group  p-2 rounded bg-gray-200 mx-3 cursor-pointer " onClick={OpenGrpBox}>Create New Group <span className="font-semibold text-2xl"> +</span> </div>
            </div>

            {
                ...
                (
                    ...
                    <div className="my-chats-box h-[80%] overflow-scroll p-2  bg-gray-100">
                        {
                            chats &&
                            chats.map((ele, i) => {
                                return (
